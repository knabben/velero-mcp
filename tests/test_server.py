"""Tests for velero MCP server core functionality."""
    ...
    def test_get_tool_config(self) -> None:
        ...
        with patch("core.utils.load_config") as mock_load:
            mock_load.return_value = {
                "tools": {
                    "echo": {"name": "echo", "config": {"prefix": "[TEST] "}},
                    "weather": {
                        "name": "weather",
...
class TestToolLoading:
    ...
    def test_tool_function_detection(self) -> None:
        ...
        # Verify that trigger_backup tool specifically was loaded
        assert "trigger_backup" in server.loaded_tools
